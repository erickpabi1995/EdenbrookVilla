...
<svg
onClick={()=>window.open('https://www.youtube.com/channel/UCIRLD82dc3WruJHrNKos0RQ', '_blank')}
...
<svg
onClick={()=>window.open('https://www.linkedin.com/company/qluxe-homes-ghana', '_blank')}
xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
