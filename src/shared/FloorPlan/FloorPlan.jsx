...
return isMobile ? <MobileUI content={content} setActiveTab={setActiveTab} activeTab={activeTab}/> : <DesktopUI content={content} setActiveTab={setActiveTab} activeTab={activeTab}/>
}

function DesktopUI({content,setActiveTab,activeTab}){
  return(
