...
"Option C"
  ...
  const tabContent = {
    ...
    "Option B": {
      bedrooms: "3 bedrooms, spacious lounge (including a walk-in closet in the master bedroom)",
      sub: ["PRIVATE BALCONY", "MODERN KITCHEN", "GUEST BATHROOM"],
      price: "$350,000",
      image:"../floorPlanB.jpg"
    },
    "Option C": {
      bedrooms: "2 bedrooms, compact design (including a walk-in closet in the master bedroom)",
...
const [activeType,setActiveType] = useState('Option A')
  ...
  const handleTabChange = (newTab) => {
   ...
   const handleDownload = () => {
    ...
    link.download = `floorPlan${activeTab.replace(" ","")}.jpg`;
...
function DesktopUI({content,setActiveTab,activeTab,handleDownload}){
  return(
...
function MobileUI({content,setActiveTab}){
  return(
        <div className={styles.floorPlan}>
<div className={styles.container}>
<p className={styles.title}>Floor Plans AND Unit Types</p>
...
<div className={styles.titleText}>
  ...
  <img src={content.image} alt='Placeholder Image' style={{width:'auto',height:'287px'}}/>
  <div className={styles.blogSubContainer}>
<p className={styles.blogColumn}>{content.bedrooms}</p>
<div className={styles.blogSubColumn}>
