...
const Footer = () => {
 ...
 const Company = [
  {
    name:"Company",
    children:['Our Projects', 'Partner Agents', 'Investors', 'Insights', 'Contact']
  },
   {
    name:"Insights",
    children:['All', 'Market Reports', 'Press Releases', 'Events & Exhibitions', 'Social Highlights', 'Real Estate Trends']
  },
   {
    name:"Resources",
    children:['Insights', 'Support']
  },
    {
    name:"Contact Us",
    children:['Qluxe Homes', 'Accra, Ghana', '+233 xxx xxx', 'contact@qluxehomes.com']
  },
...
<div className={styles.titleDescription}>
  <p className={styles.button}> {item.name}</p>
  <div className={styles.insights}>
{item.children.map((it)=>
<p className={styles.insightCard}>{it}</p>
    )}
...
<div className={styles.blogSubColumn}>
  <div className={styles.blogSub}>
    <p className={styles.badge}>© 2025 Qluxe Homes</p>
    <svg xmlns="http://www.w3.org/2000/svg" width="2" height="2" viewBox="0 0 2 2" fill="none">
  <circle cx="1" cy="1" r="1" fill="white"/>
</svg>
<p className={styles.badge}>Terms</p>
<svg xmlns="http://www.w3.org/2000/svg" width="2" height="2" viewBox="0 0 2 2" fill="none">
  <circle cx="1" cy="1" r="1" fill="white"/>
</svg>
<p className={styles.badge}>Privacy</p>
  </div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  <g clip-path="url(#clip0_11157_10798)">
